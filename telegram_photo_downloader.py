...
Downloads photos and/or videos from a specific chat/group based on chat ID and date range.
"""
...
class TelegramPhotoDownloader:
    ...
    async def download_media(self, chat_id, start_date=None, end_date=None, output_dir='downloads', media_types=['photo']):
        """
        Download photos and/or videos from a specific chat within a date range.
        ...
        Args:
            ...
            media_types: List of media types to download ['photo', 'video', or both]
        """
        ...
        async for message in self.client.iter_messages(chat, reverse=False):
            ...
            # Check for videos (documents with video mime type)
            elif 'video' in media_types and isinstance(message.media, MessageMediaDocument):
...
async def main():
    parser = argparse.ArgumentParser(
        description='Download photos from Telegram chats/groups',
...
Examples:
  ...
  python telegram_photo_downloader.py --chat-id -1001234567890 --start-date 2024-01-01 --end-date 2024-12-31

  # Download videos from the last 7 days
  python telegram_photo_downloader.py --chat-id -1001234567890 --start-date 2024-12-23 --media-type video
...
Note: You need to create a Telegram app at https://my.telegram.org to get API_ID and API_HASH
    ...
    parser.add_argument('--media-type',
                        ...
                        default='photo',
                        help='Media type to download: photo, video, or both (default: photo)')
